function Week({ info, temp }) {
  ...
  return (
    <div className=" p-3 mb-1 rounded-lg flex justify-between items-center text-white w-814 bg-gradient-to-r via-purple-500 from-green-600 to-black max-lg:w-600 max-md:max-w-4xl ">
      <h3>
        Date: {month}/{day}
      </h3>
      <img
